			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-6">
						<span>Trang chủ / Sản phẩm/ Bánh Cấp Đông</span>
					</div>
					<div class="col-sm-3 col-lg-3">
						...
						<div class="pagination">
					       <?php if ($data_tong >= 9 ) {
								for ($i = 1; $i <= $data_tong / 9; $i++) { ?>
									<a class="active chinh_menu" style="background-color: #9e563c;border-radius: 25%;" href="?act=list_belt&trangthatlung=<?= $i ?>"><?= $i ?></a>
							<?php }
							}
							?>
					    </div>
