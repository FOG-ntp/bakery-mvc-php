			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-6">
						<span>Trang chủ / Sản phẩm/ Bánh nướng</span>
					</div>
					<div class="col-sm-3 col-lg-3">
							...
							<div class="pagination">
						       <?php if ($data_tong >= 9) {
									for ($i = 1; $i <= $data_tong / 9; $i++) { ?>
										<a name="trang_ao" style="background-color: #9e563c;border-radius: 25%;" class="active chinh_menu" href="?act=list_shirt&trangao=<?= $i ?>"><?= $i ?></a>
								<?php }
								}
								?>
						    </div>
